...
<div class="min-h-[calc(100vh-56px)] bg-linear-to-br from-emerald-100 via-green-50 to-white px-4 py-10">
	<div class="mx-auto w-full max-w-md rounded-2xl bg-white p-6 shadow-lg">
		<h1 class="text-2xl font-bold text-emerald-900">Login Lima Waktu</h1>
		<p class="mt-1 text-sm text-slate-600">Masuk sebagai Admin Masjid atau Superadmin.</p>

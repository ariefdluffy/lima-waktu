<script lang="ts">
    /**
     * Tombol WhatsApp CTA untuk perpanjang langganan.
     * Nomor dikontrol via prop dengan default fallback.
     */
    let {
        phone = "6285250887277",
        message = "Halo, saya ingin memperpanjang langganan Lima Waktu untuk masjid saya.",
    }: {
        phone?: string;
        message?: string;
    } = $props();
